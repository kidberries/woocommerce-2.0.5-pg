DROP TABLE IF EXISTS "wp_woocommerce_attribute_taxonomies";CREATE TABLE "wp_woocommerce_attribute_taxonomies" ( "attribute_id" BIGSERIAL, "attribute_name" varchar(200) NOT NULL, "attribute_label" TEXT, "attribute_type" varchar(200) NOT NULL, "attribute_orderby" varchar(200) NOT NULL, attribute_description text);
