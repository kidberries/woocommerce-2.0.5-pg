...
function woocommerce_top_sellers() {
	...
	$order_items = apply_filters( 'woocommerce_reports_top_sellers_order_items', $wpdb->get_results( "
		SELECT order_item_meta_2.meta_value as product_id, SUM( CAST(order_item_meta.meta_value AS NUMERIC) ) as item_quantity FROM {$wpdb->prefix}woocommerce_order_items as order_items
...
function woocommerce_top_earners() {
	...
	$order_items = apply_filters( 'woocommerce_reports_top_earners_order_items', $wpdb->get_results( "
		SELECT order_item_meta_2.meta_value as product_id, SUM( CAST(order_item_meta.meta_value AS NUMERIC) ) as line_total FROM {$wpdb->prefix}woocommerce_order_items as order_items
