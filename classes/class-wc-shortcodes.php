...
class WC_Shortcodes {
	...
	public function changeable( $atts ) {
		global $woocommerce;
		return $woocommerce->shortcode_wrapper( array( 'WC_Shortcode_Changeable', 'output' ), $atts );
	}
	...
	public function changeables( $atts ) {
		global $woocommerce;
		return $woocommerce->shortcode_wrapper( array( 'WC_Shortcode_Changeables', 'output' ), $atts );
	}
