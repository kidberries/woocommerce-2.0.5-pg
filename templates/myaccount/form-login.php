...
<?php else: ?>
		<h2><?php _e( 'Sorry, registration of new users is suspended', 'woocommerce' ); ?></h2>
		...
		<form method="post" class="register">
			...
			<p class="form-row">
				<?php $woocommerce->nonce_field('register', 'register') ?>
				<input type="submit" class="button disabled" name="register" disabled="disabled" value="<?php _e( 'Register', 'woocommerce' ); ?>" />
			</p>
		</form>
<?php endif; ?>
	</div>
